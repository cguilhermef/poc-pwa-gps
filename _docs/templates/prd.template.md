...
[Descreva o diagrama de casos de uso para o PRD usando mermaid]
...
[Capture apenas restrições e considerações de alto nível (**evite soluções de design – essas pertencem à Tech Spec que será gerada em outro momento**):
